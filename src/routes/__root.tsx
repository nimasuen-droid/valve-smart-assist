...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Practical valve selection support for process piping applications. Body, trim, seat, end-connection and special service guidance." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Valve Selection Guide — Engineering Decision Support" },
      { name: "twitter:description", content: "Practical valve selection support for process piping applications. Body, trim, seat, end-connection and special service guidance." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/68f5658b-2332-4b06-a073-14fb6e57f014/id-preview-e1f275a7--31c54872-770e-4f9c-9043-13080de33216.lovable.app-1777763673028.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/68f5658b-2332-4b06-a073-14fb6e57f014/id-preview-e1f275a7--31c54872-770e-4f9c-9043-13080de33216.lovable.app-1777763673028.png" },
