  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:card", content: "summary_large_image" },
      {
        name: "description",
        content:
          "A decision-support web app that helps piping & process engineers screen the right industrial valve for a given service.",
      },
      {
        property: "og:description",
        content:
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c94f89df-b580-4a3b-8ec5-eec8d61abce3",
      },
      {
        name: "twitter:image",
        content:
