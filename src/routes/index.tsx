...
const recentProjects = [
  {
    id: "P-2041",
    name: "HP Steam Header — Block Valve",
  ...
  {
    id: "P-2039",
    name: "Amine Regen Bottoms",
    service: "Lean Amine, sour",
    size: "NPS 4 · CL300",
    updated: "Yesterday",
  ...
  {
    id: "P-2034",
    name: "LNG Loading Line ESDV",
    service: "LNG, cryogenic",
    size: "NPS 16 · CL300",
    updated: "3 days ago",
    state: "Review needed",
  },
...
const cautions = [
  {
    icon: Flame,
    title: "Fire-safe required",
    body: "Hydrocarbon service above 0.5 barg should default to API 607 / 6FA fire-tested designs.",
  },
  {
    icon: Snowflake,
    title: "Cryogenic temperature",
    body: "Below −46 °C use extended bonnet, ASTM A352 LCC body, and qualified low-temp trim.",
  },
  {
    icon: Droplet,
    title: "Sour service",
    body: "Confirm NACE MR0175 / ISO 15156 hardness limits on all wetted parts and bolting.",
  },
];
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border bg-gradient-surface p-6 shadow-elevated md:p-10">
        ...
        <div className="relative max-w-2xl">
          ...
          <p className="mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground md:text-base">
            ...
            conditions, valve duty and special service flags — get a defensible recommendation with
            references, alternatives, and engineering cautions.
          </p>
        ...
        {[
          {
            ...
            to: "/wizard/project",
            desc: "Project & line data",
          },
          {
            icon: ClipboardList,
            label: "Review Inputs",
            to: "/wizard/conditions",
            desc: "Service conditions",
          },
          {
            icon: Sparkles,
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {cautions.map((c) => (
              <div
                key={c.title}
                className="flex gap-3 rounded-md border border-border bg-card/40 p-3"
              >
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          ...
          <CardContent className="grid gap-3 sm:grid-cols-2">
            <ReferenceBubble
              standard="API 600"
              note="Bolted-bonnet steel gate valves for petroleum / NG industries."
            />
            <ReferenceBubble
              standard="API 602"
              note="Compact steel gate, globe and check valves for sizes ≤ NPS 4."
            />
            <ReferenceBubble
              standard="API 6D"
              note="Pipeline ball, plug, gate and check valve specification."
            />
            <ReferenceBubble
              standard="API 607 / 6FA"
              note="Fire test for quarter-turn / soft-seated valves."
            />
            <ReferenceBubble
              standard="ASME B16.34"
              note="Pressure-temperature ratings for flanged, threaded, welded valves."
            />
            <ReferenceBubble
              standard="NACE MR0175"
              note="Materials for use in H₂S-containing environments (sour service)."
            />
          </CardContent>
        </Card>
      </section>
